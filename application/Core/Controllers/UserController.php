...
class Core_UserController extends Core_IndexController
{
    ...
    public function jsonSaveAction()
    {
		...
		$responseTT = $TimeTracker->createUser(
						$this->getRequest()->getParams()['firstname'] . ' ' . 
						$this->getRequest()->getParams()['lastname'],
						$this->getRequest()->getParams()['username'],
						$this->getRequest()->getParams()['password'],
						$this->getRequest()->getParams()['email'] );
            } else {
                $model   = $this->getModelObject()->find($id);
                $message = Phprojekt::getInstance()->translate(self::EDIT_TRUE_TEXT);

		$responseTT = $TimeTracker->updateUser(
						$model->timetrackerId,
						$this->getRequest()->getParams()['firstname'] . ' ' . 
						$this->getRequest()->getParams()['lastname'],
						$this->getRequest()->getParams()['username'],
            ...
            if($responseTT) {
		$parameters = array_merge( $this->getRequest()->getParams(), 
						array('timetrackerId' => $responseTT->ID));

	      	$params = $this->setParams($parameters, $model);
