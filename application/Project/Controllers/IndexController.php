...
class Project_IndexController extends IndexController
{
     ...
     * </pre>
     * 
     * Envio de informacion a la clase de conexion con API - My_Timetracker
     * 
     * CreateProject - projectId == 1
     * 		<Title><Notes>
     * UpdateProject - projectId == 1
     * 		<Title><Notes>
     * 
    ...
    public function jsonSaveAction()
    {
	    ...
	    $parameters = $TimeTracker->execCreatorAction(	$this->getModelObject(), 
								$this->getRequest(), 
	    ...
	    $parameters = $TimeTracker->execUpdaterAction(	$model, 
								$this->getRequest(), 
								new Phprojekt_User_User());
        }
