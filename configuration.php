...
; UNIX
uploadPath = "/home/alltic/public_html/televida/proyectos/data/upload/"
; WINDOWS
;uploadPath = "C:\phprojekt_private\upload\"

; Path where will be placed temporaly files.
; UNIX
tmpPath = "/home/alltic/public_html/televida/proyectos/data/upload/"
; WINDOWS
;tmpPath = "C:\phprojekt_private\upload\"

; Path where will be placed modules created by the admin.
; UNIX
applicationPath = "/home/alltic/public_html/televida/proyectos/data/application/"
; WINDOWS
;applicationPath = "C:\phprojekt_private\application\"

; Path where webdav resides
; UNIX
webdavPath = "/home/alltic/public_html/televida/proyectos/data/webdav/"
; WINDOWS
...
; the database.
database.params.username = aws_1
database.params.password = Alltic2017
...
; UNIX
log.debug.filename = "/home/alltic/public_html/televida/proyectos/logs/debug.log"
; WINDOWS
...
; UNIX
log.err.filename = "/home/alltic/public_html/televida/proyectos/logs/err.log"
; WINDOWS
